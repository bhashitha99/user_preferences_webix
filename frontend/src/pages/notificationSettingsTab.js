              ...
              elements: [
                {rows:[
                    ...
                    },
                    {
                        ...responsiveLayout([
                            {rows:[
                                boxWithoutEditPermission("Meeting Reminders", "meetingReminders", "switch",0,200),
                                boxWithoutEditPermission("Timesheet Reminders", "timesheetReminders", "switch",0,200),
                                boxWithoutEditPermission("Project Updates", "projectUpdates", "switch",1,200),
                                boxWithoutEditPermission("Team Mentions", "teamMentions", "switch",1,200),

                            ]},
                            {rows:[
                                boxWithoutEditPermission("Leave Request Status", "reaveRequestStatus", "switch",1,200),
                                boxWithoutEditPermission("Task Assignments", "taskAssignments", "switch",1,200),
                                boxWithoutEditPermission("Announcement Updates", "announcementUpdates", "switch",0,200),
                    ...
                    {margin: 10,
                        ...
                        ...responsiveLayout([
                            {rows:[
                                boxWithoutEditPermission("Email Alerts", "emailAlerts", "switch", 1, 200),
                                boxWithoutEditPermission("SMS Alerts", "smsAlerts", "switch", 0, 200),
                                boxWithoutEditPermission("Push Notifications", "pushNotifications", "switch", 1, 200),

                            ]},
                            {rows:[
                                boxWithoutEditPermission("Browser Notifications", "browserNotifications", "switch", 1, 200),
                                boxWithoutEditPermission("Desktop Notifications", "desktopNotifications", "switch", 0, 200),
                   ...
                   {margin: 10,
                    ...
                    {rows:[
                        boxWithoutEditPermission("Notification Sound", "notificationSound", "combo",
                          [
                        ...
                        boxWithoutEditPermission("Enable Sound Alerts", "enableSoundAlerts", "switch", 1, 200),
                        {
                        rows: [
                        {
                            view: "switch",
                ...
                cols: [
                    ...
                    click: function () {
                        ...
                        callback: function (result) {
                            ...
                            $$("notificationForm").setValues(notificationInitialValues);
                            webix.message("Settings have been reset.");
                            }
                        }
                        });
                    }
                    ...
                    click: function () {
                        ...
                        callback: function (result) {
                            if (result) {
                            saveFormData("notificationForm", "http://localhost:8000/api/user/notifications")
                                .then(() => {
